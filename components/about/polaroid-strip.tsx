...
const PHOTOS: Polaroid[] = [
  { id: "a", rotate: -8, src:"/foto1.webp"},
  { id: "b", rotate: 6, src:"/foto2.webp"},
  { id: "c", rotate: -4, src:"/foto3.webp"},
  { id: "d", rotate: 7, src:"/foto4.webp"},
  { id: "e", rotate: -6, src:"/foto5.webp"},
  { id: "f", rotate: 5, src:"/foto6.webp"},
];
  ...
  return (
    ...
    >
      <img 
        ...
        className="relative h-full w-full object-cover overflow-hidden rounded-xl pointer-events-none" 
      />
    </motion.div>
  );
}
